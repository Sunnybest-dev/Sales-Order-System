...
const Invoice = sequelize.define('Invoice', {
  ...
  order_id: { type: DataTypes.CHAR(36), references: { model: 'orders', key: 'id' } },
  customer_id: { type: DataTypes.CHAR(36), references: { model: 'customers', key: 'id' } },
  issued_by: { type: DataTypes.CHAR(36), references: { model: 'users', key: 'id' } },
...
const Transaction = sequelize.define('Transaction', {
  ...
  recorded_by: { type: DataTypes.CHAR(36), references: { model: 'users', key: 'id' } },
...
const InventoryLog = sequelize.define('InventoryLog', {
  id: { type: DataTypes.CHAR(36), defaultValue: DataTypes.UUIDV4, primaryKey: true },
  product_id: { type: DataTypes.CHAR(36), references: { model: 'products', key: 'id' } },
...
const Notification = sequelize.define('Notification', {
  id: { type: DataTypes.CHAR(36), defaultValue: DataTypes.UUIDV4, primaryKey: true },
  user_id: { type: DataTypes.CHAR(36), references: { model: 'users', key: 'id' } },
  title: { type: DataTypes.STRING(200), allowNull: false },
