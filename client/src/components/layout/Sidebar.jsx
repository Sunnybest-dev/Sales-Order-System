...
const NAV = [
  ...
  { to: '/products', icon: '📦', label: 'Products', roles: ['super_admin', 'manager'] },
...
export default function Sidebar({ open, onClose }) {
  ...
  const allowed = user?.role ? NAV.filter((item) => item.roles.includes(user.role)) : [];
    ...
    <>
      ...
      >
        <div className="flex items-center gap-3 px-5 py-5 border-b border-gray-100">
          ...
          <div>
            <p className="font-bold text-gray-900 text-sm leading-tight">SalesOrder Pro</p>
